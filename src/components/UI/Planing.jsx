...
const PricingPlan = () => {
  ...
  useEffect(() => {
    // Set default startDate to today at 10 AM
    const now = new Date();
    ...
    <>
      <div className="form-container">
        <div className="button-group">
          ...
          <div className="form-groups">
            <label htmlFor="modifyButton" className="hidelable" style={{color:"white"}}>E </label>
            <input
              type="button"
              id="modifyButton"
              className="form-control-button"
              value="Modify Search"
              onClick={handleSearch} // Added onClick to handle search
            />
          </div>
          </div>
        </div>
